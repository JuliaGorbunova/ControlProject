...
class MainPage(WebPage):
    ...
    for_business=WebElement(classname='hiddenOnOrange white')
    ...
    bookmarks=WebElement(xpath='//a[@title="Вход в Личный кабинет"]')
    basket=WebElement(xpath='//a[@href="/bookmarks.html"]')
    all_promotions=WebElement(xpath='//a[@href="/actions/"]')
    categoty_menu=WebElement(classname='catalogLine__panel__left')
